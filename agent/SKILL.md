...
> **注意**：講稿僅供參考，目前不會用於 TTS。

撰寫約 200-250 字的旁白，**帶 section marker**，結構如下：
...
**重要：講稿長度決定影片時長。** 各段字數間接控制每個鏡頭秒數（約每秒 4 字），請合理分配：
- OPENING：約 2-3 秒（8-12 字）
...
| `title` | 5-8 字社群標題 |
| `narration` | 帶 section marker 的完整講稿，純文字（僅供參考，目前不用於 TTS） |
